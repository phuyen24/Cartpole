...
import gym
import pygame
from DQN import DQN, SOLVED_MEAN_REWARD

# ── Palette (từ HTML design) ─────────────────────────────────────────────────
BG      = (247, 250, 252)   # #f7fafc  background
CART_C  = ( 27,  43,  91)   # #1B2B5B  cart
POLE_C  = (255, 127,  80)   # #FF7F50  pole
TRACK_C = ( 24,  28,  30)   # #181c1e  track lines
PIVOT_C = (235, 238, 240)   # surface-container  pivot circle
PANEL   = ( 36,  46,  63)   # #242e3f  stats panel bg
TXT_DIM = (189, 199, 220)   # tertiary-fixed-dim
TXT_WHT = (255, 255, 255)   # on-tertiary
GREEN   = ( 16, 185, 129)   # #10B981  reward values
BORDER  = (197, 198, 208)   # outline-variant
